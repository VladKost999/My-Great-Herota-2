...
define config.name = _("Моя великая по*бень 2")
...
define build.name = "MyGreatHerota2"
...
define config.save_directory = "MyGreatHerota2-1656865421"
